...
def cosine_similarity_search(query_vector, database_filepath, top_n=None, threshold=None):
    ...
    df['similarity'] = df['Embeddings'].apply(lambda x: cosine_similarity([x], [query_vector])[0][0])
