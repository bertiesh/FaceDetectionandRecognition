...
from src.facematch.utils.yolo_utils import get_target_size
        ...
        try:
            ...
            if len(boxes) > 0:
                ...
                for i, (box, score, landmark) in enumerate(zip(boxes, scores, landmarks)):
                    ...
                    cv2.putText(viz_img, f"Score: {score:.2f}", (x1, y1-10), 
                    ...
                    if landmark:
                        for j, point in enumerate(landmark):
                            ...
                            cv2.putText(landmark_viz, str(j), (x+3, y+3), 
                    ...
                    if landmark and len(landmark) >= 5:
                        ...
                        if improved_box:
                            ...
                            cv2.putText(landmark_box_viz, "Landmark Box", (lx1, ly1-10), 
                    ...
                    for step_name, step_img in steps_viz:
                        output_path = os.path.join(viz_dir, f"{base_filename}_face{i}_{step_name}.jpg")
